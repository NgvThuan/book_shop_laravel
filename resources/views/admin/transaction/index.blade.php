                                            ...
                                            <td>
                                                @if ($transaction->payment)
                                                    <ul>
                                                        ...
                                                        <li>Tổng tiền:  {{ number_format($transaction->tst_total_money,0,',','.') }} đ</li>
                                                        <li>Lưu ý: {{ $transaction->payment->p_note }}</li>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            <a href="{{  route('admin.transaction.delete', $transaction->id) }}" class="js-delete-confirm"><i class="fa fa-trash"></i> Xoá</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
