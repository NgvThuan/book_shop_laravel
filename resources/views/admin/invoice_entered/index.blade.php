                            ...
                            @if (isset($invoiceEntered))
                                    @foreach($invoiceEntered as  $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.invoice_entered.update', $item->id) }}" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i> Sửa</a>
                                                <a href="{{  route('admin.invoice_entered.delete', $item->id) }}" class="btn btn-xs btn-danger js-delete-confirm"><i class="fa fa-trash"></i> Xoá</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
