                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <div class="form-group ">
                                        ...
                                        <label for="e_position_5">Trên </label>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group ">
                                        <input type="checkbox" name="e_position_6" value="1" id="e_position_6">
                                        <label for="e_position_6">Dưới </label>
                                    </div>
                                </div>
                            </div>
                        </div>
