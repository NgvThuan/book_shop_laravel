...
@section('content')
    <div class="container">
        <div class="product-list">
            <div class="left">
                @if (isset($category))
                @include('frontend.pages.product.include._inc_sidebar', compact('category'))
                @else
            ...
            <div class="right">
                <div class="breadcrumb">
                    <ul>
                        ...
                        @if(isset($category))
                        <li >
                            <a itemprop="url" href="{{  route('get.category.list', $category->c_slug.'-'.$category->id) }}" title="Home"><span itemprop="title">{{ $category->c_name }}</span></a>
                        </li>
                        @endif
                    </ul>
                </div>
