...
{{--                            @include('frontend.pages.product_detail.include._inc_keyword')--}}
                        ...
                        <div class="ads">
                            <a href="#" title="Giam giá" target="_blank">
                                <img alt="Hoan tien" style="width: 100%; float: right;" src="{{ isset($event1->e_banner) ? pare_url_file($event1->e_banner) : asset('images/banner/detail_banner_top.jpg') }}">
                            </a>
                        </div>
        ...
        <div class="col-md-12">
            <h1 style=" margin-top: 50px;font-size: 20px;font-weight: bold;text-transform: uppercase;">Sản phầm cùng danh mục</h3>
        </div>
        <div class="card-body product-des">
            ...
            <div class="right">
                <a href="#" title="Giam giá" target="_blank">
                    <img alt="Hoan tien" style="width: 100%" src="{{ isset($event3) ? pare_url_file($event3->e_banner) : asset('images/banner/detail_banner_bottom.jpg') }}">
                </a>
            </div>
        </div>
    </div>
