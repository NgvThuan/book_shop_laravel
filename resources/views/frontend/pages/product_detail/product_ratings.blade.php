...
@section('css')
<style>
    <?php $style = file_get_contents('css/ratings_insights.min.css');
    echo $style; ?>
</style>
@stop
@section('content')
<div class="container">
    <div class="breadcrumb">
        <ul>
            ...
            <li>
                <a itemprop="url" href="" title=""><span itemprop="title">{{ isset($product) ? $product->pro_name : '' }}</span></a>
            </li>
            <li>
                <a itemprop="url" href="" title=""><span itemprop="title">Tất cả đánh giá</span></a>
            </li>
        </ul>
    </div>
    <div class="card">
